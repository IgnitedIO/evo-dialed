...
// API Imports
import { getTopContent } from "../../../../../api/internal";
...
import { PostsFilterMenu } from "../../../Creators/Details/modals/PostsFilterMenu";
import { PostsSortMenu } from "../../../Creators/Details/modals/PostsSortMenu";
...
export default function PostsTab({
	...
	const loadPosts = async () => {
		try {
			...
			const response = await getTopContent(period, PAGE_SIZE, null, true, campaign.id, null);
	...
	const loadMorePosts = async () => {
		...
		try {
			...
			const response = await getTopContent(period, PAGE_SIZE, contentPagination.cursor, false, campaign.id, null);
