...
// API Imports
import { getCreatorCampaignCreatives } from "../../../../api/creators";

// Component Imports
import LoadingCircle from "../../../../ui/Components/LoadingCircle/LoadingCircle";
import CreativeApprovalSubmitModal from "../../CreativeApproval/modals/CreativeSubmitModal";
import CreativeApprovalDetailsModal from "../../CreativeApproval/modals/CreativeDetailsModal";
import { EmptyView } from "../../../../ui/Components";

// Style Imports
import styles from "../Campaigns.module.css";
import approvalStyles from "../../CreativeApproval/styles/CreativeApproval.module.css";
...
export default function CreativeApprovalsTab({ campaign }) {
	...
	const loadCreatives = async () => {
		try {
			...
			const response = await getCreatorCampaignCreatives(
				campaign.id,
				1,
				PAGE_SIZE,
				statusFilter,
	...
	useEffect(() => {
		loadCreatives();
	}, [campaign.id, statusFilter, timeFrameFilter, sortBy, refreshCount]);
	...
	// Handle submit button click - pre-configure with campaign info
	...
	return (
		<>
			...
			>
				...
				<div style={{ position: "relative" }}>
					...
					{(activeDropdown === "filter") && (
						<>
							...
							/>
							<div className={`${styles.dropdownMenu} ${styles.left}`}>
				...
				{/* Submit Button */}
				<div style={{ position: "relative" }}>
					<button className="createButton flex" onClick={handleSubmitClick}>
